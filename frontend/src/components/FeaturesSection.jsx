...
export default function FeaturesSection() {
  return (
    <section className="py-24 bg-nk-dark text-white relative overflow-hidden" id="features">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-16">
          <span className="text-nk-gold font-bold uppercase tracking-[0.2em] text-xs mb-4 block">World-Class Engineering</span>
          <h2 className="text-4xl md:text-6xl font-black mb-6 leading-tight">Superior Features for <br/><span className="text-nk-gold">Unmatched Performance.</span></h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((f) => (
            <div 
              key={f.title} 
              className="group relative bg-white/5 border border-white/10 p-10 rounded-[2.5rem] hover:bg-white/10 hover:border-nk-gold/20 transition-all duration-500 overflow-hidden"
            >
              ...
              <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center text-4xl mb-8 group-hover:scale-110 group-hover:bg-nk-gold transition-all duration-500 group-hover:text-nk-dark">
                {f.icon}
              </div>
