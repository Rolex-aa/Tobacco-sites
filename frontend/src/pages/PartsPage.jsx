      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-black text-nk-text tracking-tight mb-4 transition-colors duration-300">
            Precision <span className="text-nk-gold">Parts</span>
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {parts.map((part) => (
            <div key={part.id} className="bg-nk-card rounded-3xl overflow-hidden shadow-xl border border-nk-border hover:border-nk-gold/50 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-nk-gold/10 flex flex-col group">
              ...
              <div className="p-7 flex flex-col flex-grow">
                <h3 className="text-xl font-black text-nk-text mb-2 line-clamp-1 transition-colors duration-300">{part.name}</h3>
                ...
                <div className="mt-auto mb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-tighter text-nk-green bg-nk-green/10 px-2 py-1 rounded">Genuine</span>
                  </div>
                </div>
